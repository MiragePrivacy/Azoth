...
const SIMPLE_DEPLOYMENT: &str =
    "0x6028600c60003960286000f360003560e01c80637ff36ab514601e578063a9059cbb14602357600080fd5b600080fd5b600080fd";
...
async fn test_dispatcher_transformation_and_determinism() {
    ...
    let result1 = obfuscate_bytecode(SIMPLE_DEPLOYMENT, SIMPLE_BYTECODE, config1)
        .await
        .unwrap();
    let result2 = obfuscate_bytecode(SIMPLE_DEPLOYMENT, SIMPLE_BYTECODE, config2)
        .await
        .unwrap();
    ...
    assert_ne!(
        result1.obfuscated_bytecode, SIMPLE_DEPLOYMENT,
